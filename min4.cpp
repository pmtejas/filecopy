...
int main() {
    ...
    for (int i = 0; i < numDirs; ++i) {
        std::cout << "Enter destination directory name " << i + 1 << " within C:/Users/Yasir.arfath/Desktop/destination: ";
        std::getline(std::cin, destDir);
        destinationDirs.push_back("C:/Users/Yasir.arfath/Desktop/destination/" + destDir);
    }
